...
{\centering
{\fontsize{32pt}{36pt}\selectfont Systemy uczące się}\\[0.5cm]
{\fontsize{32pt}{36pt}\selectfont Laboratorium}\\[2.5cm]
}
\vfill
...
%%  Metadane dokumentu 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Naiwny klasyfikator bayesowski.}
\titleShort{Naiwny klasyfikator bayesowski.}
...
\promotor{dr inż. Paweł Myszkowski}
\date{WROCŁAW, 2017}
